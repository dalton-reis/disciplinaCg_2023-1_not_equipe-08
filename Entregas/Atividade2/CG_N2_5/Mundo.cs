...
namespace gcgcg
{
  public class Mundo : GameWindow
  {
    ...
    protected override void OnLoad()
    {
      ...
      #region Circulo maior
      circuloMaior = new Circulo(null, 0.3f);
      ObjetoNovo(circuloMaior);
      #endregion

      #region Circulo menor
      this.objetoSelecionado = new Circulo(null, 0.1f);
      ObjetoNovo(objetoSelecionado); 
      #endregion

      #region Ponto
      pontoCentro = new Ponto(null, new Ponto4D());
      pontoCentro.PrimitivaTipo = PrimitiveType.Points;
      pontoCentro.PrimitivaTamanho = 10;
      ObjetoNovo(pontoCentro);
      #endregion
      ...
      caixa = new Retangulo(null, new Ponto4D(ptoDireita), new Ponto4D(ptoEsquerda));
      caixa.PrimitivaTipo = PrimitiveType.LineLoop;
      ObjetoNovo(caixa);
      #endregion
